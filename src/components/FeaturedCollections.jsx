...
//   return (
//     <section className="bg-white h-[590px] flex flex-col justify-center">
...
//         <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-black mb-12">
//           Featured Collections
//         </h2>

//         {/* Circles */}
//         <div className="grid grid-cols-2 sm:grid-cols-4 gap-y-10 gap-x-6 items-center justify-items-center">
//           {items.map((it) => (
//             <div
//               key={it.id}
//               className="relative group flex items-center justify-center cursor-pointer"
//             >
//               {/* Bigger circular frame */}
//               <div className="rounded-full border border-gray-200 w-72 h-72 lg:w-80 lg:h-80 flex items-center justify-center overflow-hidden transition-transform duration-300 group-hover:scale-105">
//                 {/* Image */}
//                 <img
//                   src={it.img}
//                   alt={it.title}
//                   className="object-contain w-[75%] h-[75%] transition-transform duration-300 group-hover:scale-110"
//                 />

//                 {/* Overlay */}
//                 <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-full flex flex-col items-center justify-center text-white">
//                   <p className="text-lg font-semibold">{it.title}</p>
//                   <p className="text-sm text-gray-200">{it.count}</p>
//                 </div>
//               </div>
//             </div>
//           ))}
