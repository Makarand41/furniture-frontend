...
//         <div className="max-w-7xl mx-auto flex items-center text-sm text-gray-700 space-x-2">
//           <Link
//             to="/"
...
//       {/* Hero Section */}
//       <div
//         className="relative flex items-center justify-center h-[280px] bg-cover bg-center"
//         style={{
//           backgroundImage: `linear-gradient(rgba(0,0,0,0.25), rgba(0,0,0,0.25)), url(${productBg})`,
//         }}
//       >
//         <h1 className="text-white text-4xl md:text-5xl font-bold text-center z-10">
//           Products
//         </h1>
//       </div>
//     </div>
